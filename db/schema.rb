...
ActiveRecord::Schema.define(version: 20170406160537) do
  ...
  create_table "events", force: :cascade do |t|
    ...
    t.index ["cached_weighted_average"], name: "index_events_on_cached_weighted_average"
    t.index ["cached_weighted_score"], name: "index_events_on_cached_weighted_score"
    t.index ["cached_weighted_total"], name: "index_events_on_cached_weighted_total"
  end
