...
class RsvpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rsvp" do
    assert_difference('Rsvp.count') do
      post rsvps_url, params: { rsvp: { date: @rsvp.date, description: @rsvp.description, end_time: @rsvp.end_time, start_time: @rsvp.start_time, title: @rsvp.title } }
    end
  ...
  test "should update rsvp" do
    patch rsvp_url(@rsvp), params: { rsvp: { date: @rsvp.date, description: @rsvp.description, end_time: @rsvp.end_time, start_time: @rsvp.start_time, title: @rsvp.title } }
