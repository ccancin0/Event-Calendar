...
class CategoryEventsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create category_event" do
    assert_difference('CategoryEvent.count') do
      post category_events_url, params: { category_event: { category_id: @category_event.category_id, event_id: @category_event.event_id } }
    end
  ...
  test "should update category_event" do
    patch category_event_url(@category_event), params: { category_event: { category_id: @category_event.category_id, event_id: @category_event.event_id } }
